...
\begin{titlepage}
    ...
    {\Huge \bfseries Trabajo Práctico 1}\\[0.2cm]
    {\LARGE \bfseries Máquina de Turing: suma de dos números en binario}\\[0.2cm]
    ...
    \url{https://github.com/noequalindi/computing_algorithms/tree/main/tp1}\\[2cm]

\end{titlepage}

% Si querés que la página 1 sea la primera del contenido:
\setcounter{page}{1}
...
\begin{center}
\url{https://github.com/noeliaqualindi/computing_algorithms}
\end{center}
