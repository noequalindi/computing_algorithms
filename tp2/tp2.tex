...
\begin{titlepage}
    ...
    {\Huge \bfseries Trabajo Práctico 2}\\[0.2cm]
    {\LARGE \bfseries Closest Pair of Points (Divide y Vencerás)}\\[0.2cm]
    ...
    \url{https://github.com/noequalindi/computing_algorithms/tree/main/tp2}\\[2cm]

\end{titlepage}

\setcounter{page}{1}

% ---- CONTENIDO TP2 DESDE ACÁ ----
...
(Closest pair of points en $O(n\log n)$).
